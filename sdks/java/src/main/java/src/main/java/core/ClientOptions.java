...
public final class ClientOptions {
  ...
  private ClientOptions(Environment environment, Map<String, String> headers,
    ...
    this.headers.putAll(new HashMap<String,String>() {{put("X-Fern-Language", "JAVA");put("X-Fern-SDK-Name", "com.justin-douville.fern:api-sdk");put("X-Fern-SDK-Version", "0.0.1");}});
